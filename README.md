...
- Writing clean, readable, and reproducible analytical code
...
- Datatype correction and feature engineering
- Exploratory analysis to identify trends and patterns
- Sales, profit, discount, region, category, and segment-level insights
- Visualization-driven interpretation using Python libraries

📓 Notebook:  
`Tasks/Task_1/Task_1_EDA.ipynb`
